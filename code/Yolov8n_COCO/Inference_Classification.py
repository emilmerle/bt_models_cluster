...
# Inference
filename = f"./../../output_data/Inference_Yolov8n-cls_COCO/{device_name}.csv"
...
if device_name in ["RP4", "RP3"]:
    ...
    model = YOLO("./../../models/yolov8n-cls_ncnn_model")
elif device_name in ["JETSONNANO"]:
    pre_model = YOLO("./../../models/yolov8n-cls.pt")
    pre_model.export(format="engine")  # creates 'yolov8n.engine'
    model = YOLO("./../../models/yolov8n-cls.engine")
else:
