...
# Inference
filename = f"./../../output_data/Inference_Yolov8m-seg_COCO/{device_name}.csv"
...
if device_name in ["RP4", "RP3"]:
    ...
    model = YOLO("./../../models/yolov8m-seg_ncnn_model")
elif device_name in ["JETSONNANO"]:
    pre_model = YOLO("./../../models/yolov8m-seg.pt")
    pre_model.export(format="engine")  # creates 'yolov8n.engine'
    model = YOLO("./../../models/yolov8m-seg.engine")
else:
