...
# Inference
filename = f"./../../output_data/Inference_Yolov8m_COCO/{device_name}.csv"
...
if device_name in ["RP4", "RP3"]:
    ...
    model = YOLO("./../../models/yolov8m_ncnn_model")
elif device_name in ["JETSONNANO"]:
    pre_model = YOLO("./../../models/yolov8m.pt")
    pre_model.export(format="engine")  # creates 'yolov8n.engine'
    model = YOLO("./../../models/yolov8m.engine")
else:
